...
//   const countriesAndCapitals = Data[randomCountry];
 

//   const numberofCountries = countriesAndCapitals.length;
//   return (
//     <div>
//       <h2>The Countries and Their Capitals</h2>
//       <h2>Country: {randomCountry.country}</h2>
//       <h2>Capital: {randomCountry.capital}</h2>
//       <h2>Number of Countries: {numberofCountries}</h2>
//     </div>
//   );
// };
// export default Info;
